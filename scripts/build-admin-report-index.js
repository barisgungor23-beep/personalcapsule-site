...
const reports = [
  ...
  ["workflow_guide", "Admin workflow guide", "admin-workflow-guide-report.json"],
  ...
  ["draft_patch_export_center", "Draft patch export center", "draft-patch-export-center-report.json"],
  ...
  ["publish_wizard", "Publish wizard", "publish-wizard-report.json"],
